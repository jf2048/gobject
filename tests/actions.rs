...
mod app {
    ...
    impl MyApp {
        ...
        #[action]
        fn action8(&self, value: i32, #[action] action: &gio::SimpleAction, #[state] state: i32) {
            assert_eq!(state, action.state().unwrap().get::<i32>().unwrap());
            assert_eq!(action.name(), "action8");
            self.log(&format!("action8 {}", value));
        }
        #[action(change_state, name = "action8")]
        fn action8_change_state(&self, value: i32) {
        ...
        #[action(parameter_type = "i", default_variant = "0i32.to_variant()")]
        ...
        #[public]
        fn pub_action8_change_state(&self, value: i32) {
    ...
    impl super::MyApp {
        ...
        fn wrapper_action8_change_state(&self, value: i32) {
        ...
        #[public]
        fn pub_wrapper_action8_change_state(&self, value: i32) {
            self.imp()
...
fn actions() {
    ...
    app.connect_activate(|app| {
        ...
        app.change_action_state("action8", &80i32.to_variant());
        ...
        app.change_action_state("pub-action8", &80i32.to_variant());
        ...
        app.change_action_state("wrapper-action8", &80i32.to_variant());
        ...
        app.change_action_state("pub-wrapper-action8", &80i32.to_variant());
